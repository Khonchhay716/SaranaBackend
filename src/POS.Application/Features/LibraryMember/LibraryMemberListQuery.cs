// POS.Application/Features/LibraryMember/LibraryMemberListQuery.cs
using MediatR;
...
{
    public class LibraryMemberListQuery : PaginationRequest, IRequest<PaginatedResult<LibraryMemberInfo>>
    {
    ...
    public class LibraryMemberListQueryHandler : IRequestHandler<LibraryMemberListQuery, PaginatedResult<LibraryMemberInfo>>
    {
        private readonly IMyAppDbContext _context;

        public LibraryMemberListQueryHandler(IMyAppDbContext context)
        {
            _context = context;
        }

        public async Task<PaginatedResult<LibraryMemberInfo>> Handle(LibraryMemberListQuery request, CancellationToken cancellationToken)
        {
